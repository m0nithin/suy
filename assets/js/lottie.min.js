...
var fC = (r, C, i) =>
  C in r
    ? JC(r, C, { enumerable: !0, configurable: !0, writable: !0, value: i })
    : (r[C] = i);
...
var _I = class {
  ...
  VI = class {
    constructor() {
      Z(this, "_strategy");
      this._strategy =
        typeof requestAnimationFrame == "function" ? new _I() : new $I();
    }
    requestAnimationFrame(C) {
...
var wI = new Uint8Array([80, 75, 3, 4]),
  Eg = ["v", "ip", "op", "layers", "fr", "w", "h"],
  qI = "0.30.2",
  Ig = "@lottiefiles/dotlottie-web";
var TC = (() => {
    ...
    return function (C = {}) {
      ...
      var $ = i.print || console.log.bind(console),
        q = i.printErr || console.error.bind(console);
      ...
      function lg() {
        var I = ZI.buffer;
        (i.HEAP8 = Q = new Int8Array(I)),
          (i.HEAP16 = II = new Int16Array(I)),
          (i.HEAPU8 = y = new Uint8Array(I)),
          (i.HEAPU16 = eI = new Uint16Array(I)),
          (i.HEAP32 = w = new Int32Array(I)),
          (i.HEAPU32 = K = new Uint32Array(I)),
          (i.HEAPF32 = ng = new Float32Array(I)),
          (i.HEAPF64 = ag = new Float64Array(I));
      }
      var sg = [],
        dg = [],
        cg = [];
      ...
      var Gg = (I) => I.startsWith("data:application/octet-stream;base64,"),
        gI;
      ...
      function hg(I) {
        if (I == gI && iI) return new Uint8Array(iI);
        throw "both async and sync fetching of the wasm failed";
      }
      function _g(I) {
        return iI || typeof fetch != "function"
          ? Promise.resolve().then(() => hg(I))
      ...
      function Zg(I, g, A) {
        return _g(I)
          .then((e) => WebAssembly.instantiate(e, g))
          .then(A, (e) => {
      ...
      function $g(I, g) {
        ...
        return iI ||
          ...
          ? Zg(A, I, g)
          : fetch(A, { credentials: "same-origin" }).then((e) =>
              WebAssembly.instantiateStreaming(e, I).then(g, function (t) {
                return (
                  q(`wasm streaming compile failed: ${t}`),
      ...
      var HI = (I) => {
        ...
        bg = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0,
        x = (I, g, A) => {
          var e = g + A;
          for (A = g; I[A] && !(A >= e); ) ++A;
          if (16 < A - g && I.buffer && bg) return bg.decode(I.subarray(g, A));
          for (e = ""; g < A; ) {
            var t = I[g++];
            if (t & 128) {
              var o = I[g++] & 63;
      ...
      var CI = {},
        ...
        U = (I, g, A) => {
          function e(a) {
            ...
            for (var c = 0; c < I.length; ++c) k(I[c], a[c]);
          }
          I.forEach(function (a) {
            mI[a] = g;
          });
          var t = Array(g.length),
            o = [],
            l = 0;
          g.forEach((a, c) => {
            O.hasOwnProperty(a)
      ...
      function gC(I, g, A = {}) {
        ...
        (O[I] = g),
          delete mI[I],
          CI.hasOwnProperty(I) &&
            ((g = CI[I]), delete CI[I], g.forEach((t) => t()));
      }
      function k(I, g, A = {}) {
      ...
      var kI = (I) => {
        ...
        Kg = (I, g, A) =>
          g === A
            ...
            : A.Ca === void 0
            ? null
            : ((I = Kg(I, g, A.Ca)), I === null ? null : A.ab(I)),
        yg = {},
        aI = [],
        LI = () => {
          for (; aI.length; ) {
        ...
        sI = {},
        CC = (I, g) => {
          if (g === void 0) throw new u("ptr should not be undefined");
          for (; I.Ca; ) (g = I.Na(g)), (I = I.Ca);
          return sI[g];
        },
        BI = (I, g) => {
          if (!g.za || !g.ya)
          ...
          return (
            (g.count = { value: 1 }),
            dI(Object.create(I, { ma: { value: g, writable: !0 } }))
          );
        },
        dI = (I) =>
          typeof FinalizationRegistry > "u"
            ? ((dI = (g) => g), I)
            : ((FI = new FinalizationRegistry((g) => {
                (g = g.ma),
                  --g.count.value,
                  g.count.value === 0 &&
                    (g.Aa ? g.Da.Fa(g.Aa) : g.za.xa.Fa(g.ya));
              })),
              (dI = (g) => {
                var A = g.ma;
              ...
              dI(I));
      function pI() {}
      var cI = (I, g) => Object.defineProperty(g, "name", { value: I }),
        Yg = (I, g, A) => {
          if (I[g].Ba === void 0) {
            var e = I[g];
            (I[g] = function (...t) {
              if (!I[g].Ba.hasOwnProperty(t.length))
                throw new u(
                  `Function '${A}' called with an invalid number of arguments (${t.length}) - expects one of (${I[g].Ba})!`
                );
      ...
      var JI = (I, g, A) => {
        for (; g !== A; ) {
          if (!g.Na)
            throw new u(
              `Expected null or instance of ${A.name}, got an instance of ${g.name}`
            );
          (I = g.Na(I)), (g = g.Ca);
        }
        return I;
      ...
      function eC(I, g) {
        if (g === null) {
          if (this.Ta) throw new u(`null is not a valid ${this.name}`);
          return 0;
        }
        if (!g.ma) throw new u(`Cannot pass "${UI(g)}" as a ${this.name}`);
        if (!g.ma.ya)
          throw new u(
        ...
        if (!this.Pa && g.ma.za.Pa)
          throw new u(
            `Cannot convert argument of type ${
              g.ma.Da ? g.ma.Da.name : g.ma.za.name
      ...
      function oC(I, g) {
        ...
        if (g.ma.za.Pa)
          throw new u(
            `Cannot convert argument of type ${g.ma.za.name} to parameter type ${this.name}`
          );
        return JI(g.ma.ya, g.ma.za.xa, this.xa);
      }
      function GI(I, g, A, e, t, o, l, a, c, s, G) {
        (this.name = I),
          ...
          t || g.Ca !== void 0
            ? (this.toWireType = tC)
            : ((this.toWireType = e ? eC : oC), (this.Ea = null));
      }
      var Sg = (I, g, A) => {
          if (!i.hasOwnProperty(I))
            throw new nI("Replacing nonexistent public symbol");
          i[I].Ba !== void 0 && A !== void 0
            ? (i[I].Ba[A] = g)
            : ((i[I] = g), (i[I].Oa = A));
        },
        H,
        ...
        WI = (I, g) => {
          function A(o) {
            t[o] ||
              O[o] ||
              (mI[o] ? mI[o].forEach(A) : (e.push(o), (t[o] = !0)));
          }
          var e = [],
            t = {};
        ...
        fI = (I, g) => {
          for (var A = [], e = 0; e < I; e++) A.push(K[(g + 4 * e) >> 2]);
          return A;
        };
      function lC(I) {
        for (var g = 1; g < I.length; ++g)
          if (I[g] !== null && I[g].Ea === void 0) return !0;
        return !1;
      }
      function TI(I, g, A, e, t) {
        ...
        return cI(I, function (...n) {
          if (n.length !== s)
            throw new u(
              `function ${I} called with ${n.length} arguments, expected ${s}`
            );
      ...
      var Rg = (I) => {
        ...
        MI = (I) => {
          if (!I) throw new u("Cannot use deleted val. handle = " + I);
          return D[I];
        },
        KI = (I) => {
          switch (I) {
        ...
        Hg = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0,
        GC = (I, g) => {
          for (var A = I >> 1, e = A + g / 2; !(A >= e) && eI[A]; ) ++A;
          if (((A <<= 1), 32 < A - I && Hg)) return Hg.decode(y.subarray(I, A));
          for (A = "", e = 0; !(e >= g / 2); ++e) {
            var t = II[(I + 2 * e) >> 1];
            if (t == 0) break;
        ...
        rC = (I, g, A) => {
          ...
          for (var t = 0; t < A; ++t) (II[g >> 1] = I.charCodeAt(t)), (g += 2);
          return (II[g >> 1] = 0), g - e;
        },
        hC = (I) => 2 * I.length,
        ZC = (I, g) => {
        ...
        vg = () => {
          if (!jI) {
            var I = {
              ...
              g;
            for (g in QI) QI[g] === void 0 ? delete I[g] : (I[g] = QI[g]);
            var A = [];
            for (g in I) A.push(`${g}=${I[g]}`);
            jI = A;
          }
          return jI;
        },
        ...
        kg = (I) => (kg = KC())(I),
        yI = (I) => I % 4 === 0 && (I % 100 !== 0 || I % 400 === 0),
        Fg = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
        Lg = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
      function yC(I) {
        var g = Array(mg(I) + 1);
      ...
      var YC = (I, g, A, e) => {
        ...
        function l(n, h) {
          ...
          var S;
          return (
            (S = b(n.getFullYear() - h.getFullYear())) === 0 &&
              (S = b(n.getMonth() - h.getMonth())) === 0 &&
              (S = b(n.getDate() - h.getDate())),
            S
          );
        }
        function a(n) {
        ...
        function c(n) {
          ...
          return (
            (b = new Date(n.getFullYear() + 1, 0, 4)),
            (h = a(new Date(n.getFullYear(), 0, 4))),
            (b = a(b)),
            0 >= l(h, n)
              ? 0 >= l(b, n)
                ? n.getFullYear() + 1
        ...
        for (var G in s) A = A.replace(new RegExp(G, "g"), s[G]);
        var m =
        ...
        (s = {
          "%a": (n) => m[n.Ga].substring(0, 3),
          "%A": (n) => m[n.Ga],
          "%b": (n) => p[n.Sa].substring(0, 3),
          "%B": (n) => p[n.Sa],
          "%C": (n) => o(((n.Ja + 1900) / 100) | 0, 2),
          "%d": (n) => o(n.Va, 2),
          "%e": (n) => t(n.Va, 2, " "),
          "%g": (n) => c(n).toString().substring(2),
          "%G": c,
          "%H": (n) => o(n.Ra, 2),
          "%I": (n) => (
            (n = n.Ra), n == 0 ? (n = 12) : 12 < n && (n -= 12), o(n, 2)
          ),
          "%j": (n) => {
            for (
              var h = 0, b = 0;
              b <= n.Sa - 1;
              h += (yI(n.Ja + 1900) ? Fg : Lg)[b++]
            );
            return o(n.Va + h, 3);
          },
          "%m": (n) => o(n.Sa + 1, 2),
          ...
          "%n": () => `
`,
          "%p": (n) => (0 <= n.Ra && 12 > n.Ra ? "AM" : "PM"),
          "%S": (n) => o(n.sb, 2),
          "%t": () => "	",
          "%u": (n) => n.Ga || 7,
          "%U": (n) => o(Math.floor((n.Ia + 7 - n.Ga) / 7), 2),
          "%V": (n) => {
          ...
          "%w": (n) => n.Ga,
          "%W": (n) => o(Math.floor((n.Ia + 7 - ((n.Ga + 6) % 7)) / 7), 2),
          "%y": (n) => (n.Ja + 1900).toString().substring(2),
          "%Y": (n) => n.Ja + 1900,
          "%z": (n) => {
            n = n.qb;
            var h = 0 <= n;
        ...
        return (
          (A = A.replace(/\0\0/g, "%")),
          (G = yC(A)),
          G.length > g ? 0 : (Q.set(G, I), G.length - 1)
        );
      };
      ...
      (pg = Ng),
        ...
        Object.assign(pI.prototype, {
          isAliasOf: function (I) {
            if (!(this instanceof pI && I instanceof pI)) return !1;
            var g = this.ma.za.xa,
              A = this.ma.ya;
            I.ma = I.ma;
            var e = I.ma.za.xa;
            for (I = I.ma.ya; g.Ca; ) (A = g.Na(A)), (g = g.Ca);
            for (; e.Ca; ) (I = e.Na(I)), (e = e.Ca);
            return g === e && A === I;
          },
          clone: function () {
          ...
          delete() {
            ...
            var I = this.ma;
            --I.count.value,
              I.count.value === 0 && (I.Aa ? I.Da.Fa(I.Aa) : I.za.xa.Fa(I.ya)),
          ...
          deleteLater: function () {
            ...
            return (
              aI.push(this),
              aI.length === 1 && lI && lI(LI),
              (this.ma.Ka = !0),
              this
            );
          },
        }),
        (i.getInheritedInstanceCount = () => Object.keys(sI).length),
        (i.getLiveInheritedInstances = () => {
          var I = [],
            g;
          for (g in sI) sI.hasOwnProperty(g) && I.push(sI[g]);
          return I;
        }),
        (i.flushPendingDeletes = LI),
        (i.setDelayFunction = (I) => {
        ...
        Object.assign(GI.prototype, {
          ...
          fromWireType: function (I) {
            function g() {
              return this.Qa
                ? BI(this.xa.La, { za: this.jb, ya: A, Da: this, Aa: I })
                : BI(this.xa.La, { za: this, ya: I });
            }
            var A = this.eb(I);
            if (!A) return this.Xa(I), null;
            var e = CC(this.xa, A);
            if (e !== void 0)
              return e.ma.count.value === 0
                ? ((e.ma.ya = A), (e.ma.Aa = I), e.clone())
                : ((e = e.clone()), this.Xa(I), e);
            if (((e = this.xa.cb(A)), (e = yg[e]), !e)) return g.call(this);
            e = this.Pa ? e.$a : e.pointerType;
            var t = Kg(A, this.xa, e.xa);
            return t === null
              ? g.call(this)
              : this.Qa
              ? BI(e.xa.La, { za: e, ya: t, Da: this, Aa: I })
              : BI(e.xa.La, { za: e, ya: t });
          },
        }),
        (Vg = i.UnboundTypeError =
          ((I, g) => {
...
` +
        ...
        D.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1),
        (i.count_emval_handles = () => D.length / 2 - 5 - DI.length);
      var SC = {
          c: (I, g, A, e) => {
            bI(
              `Assertion failed: ${I ? x(y, I) : ""}, at: ` +
                [
                  g ? (g ? x(y, g) : "") : "unknown filename",
                  A,
                  e ? (e ? x(y, e) : "") : "unknown function",
                ]
            );
          },
          m: (I, g, A) => {
          ...
          v: (I) => {
            ...
            var A = g.Ua,
              e = g.Fa,
              t = g.Ya,
              o = t.map((l) => l.hb).concat(t.map((l) => l.nb));
            U([I], o, (l) => {
              var a = {};
              return (
                t.forEach((c, s) => {
            ...
            NI(n, function () {
              ...
              U([I, g, A], e ? [e] : [], (h) => {
                ...
                return (
                  (b = new GI(G, X, !0, !1, !1)),
                  (rI = new GI(G + "*", X, !1, !1, !1)),
                  (S = new GI(G + " const*", X, !1, !0, !1)),
                  (yg[I] = { pointerType: rI, $a: S }),
                  Sg(n, h),
                  [b, rI, S]
                );
              });
          ...
          f: (I, g, A, e, t, o, l, a) => {
            ...
            (g = V(g)),
              ...
              U([], [I], (s) => {
                ...
                return (
                  n === void 0 ||
                  (n.Ba === void 0 && n.className !== s.name && n.Oa === A - 2)
                    ? ((G.Oa = A - 2), (G.className = s.name), (p[g] = G))
                    : (Yg(p, g, m), (p[g].Ba[A - 2] = G)),
                  U(
                    [],
                    c,
                    (h) => (
          ...
          x: (I, g, A, e) => {
            ...
            (g = V(g)),
              ...
              k(I, {
                ...
                toWireType: (o, l) => l.value,
                argPackAdvance: 8,
                readValueFromPointer: sC(g, A, e),
                Ea: null,
              }),
              NI(g, t);
          },
          k: (I, g, A) => {
            ...
            (g = V(g)),
              ...
              (e = Object.create(e.constructor.prototype, {
                value: { value: A },
                constructor: { value: cI(`${e.name}_${g}`, function () {}) },
              })),
              (I.values[A] = e),
              (I[g] = e);
          },
            ...
            (I = V(I)),
              ...
              U(
                ...
                (a) => (
                  Sg(
                    I,
                    TI(I, [a[0], null].concat(a.slice(1)), null, t, o),
                    g - 1
                  ),
                  []
                )
          ...
          l: (I, g, A, e, t) => {
            ...
            k(I, {
              ...
              toWireType: l,
              argPackAdvance: 8,
              readValueFromPointer: cC(g, A, e !== 0),
              Ea: null,
            });
          },
          g: (I, g, A) => {
          ...
          ca: (I, g, A, e, t, o, l, a, c, s, G, m) => {
            (A = V(A)),
              ...
              U(
                ...
                [g],
                (p) => (
                  (p = p[0]), [new GI(A, p.xa, !1, !1, !0, p, e, o, a, s, m)]
                )
              );
          },
          D: (I, g) => {
            ...
            k(I, {
              ...
              toWireType: function (e, t) {
                ...
                var l = A && o ? mg(t) : t.length,
                  a = xI(4 + l + 1),
                  c = a + 4;
                if (((K[a >> 2] = l), A && o)) Bg(t, y, c, l + 1);
                else if (o)
                  for (o = 0; o < l; ++o) {
          ...
          aa: (I, g, A, e) => ((I = zI[I]), (g = MI(g)), I(null, g, A, e)),
          F: EI,
          $: (I, g, A) => {
            var e = BC(I, g),
              t = e.shift();
            ...
            var o = Array(I);
            return (
              (g = `methodCaller<(${e.map((l) => l.name).join(", ")}) => ${
                t.name
              }>`),
              mC(
                cI(g, (l, a, c, s) => {
                  for (var G = 0, m = 0; m < I; ++m)
                    (o[m] = e[m].readValueFromPointer(s + G)),
                      (G += e[m].argPackAdvance);
                  return (
                    (a = A === 1 ? pC(a, o) : a.apply(l, o)),
                    (l = []),
                    (a = t.toWireType(l, a)),
                    l.length && (K[c >> 2] = KI(l)),
                    a
          ...
          o: (I, g) => (
            (I = PI(I, "_emval_take_value")),
            (I = I.readValueFromPointer(g)),
            KI(I)
          ),
          W: () => {
            bI("");
        ...
        Y = (function () {
          function I(A) {
            return (
              ...
              dg.unshift(Y.ea),
              j--,
              i.monitorRunDependencies?.(j),
              j == 0 && tI && ((A = tI), (tI = null), A()),
              Y
            );
          }
          var g = { a: SC };
          if ((j++, i.monitorRunDependencies?.(j), i.instantiateWasm))
            try {
        ...
        L = (I) => (L = Y.ka)(I),
        N = () => (N = Y.la)();
      (i.dynCall_iijj = (I, g, A, e, t, o) =>
        (i.dynCall_iijj = Y.na)(I, g, A, e, t, o)),
        (i.dynCall_vijj = (I, g, A, e, t, o) =>
          (i.dynCall_vijj = Y.oa)(I, g, A, e, t, o)),
        (i.dynCall_jiii = (I, g, A, e) => (i.dynCall_jiii = Y.pa)(I, g, A, e)),
        (i.dynCall_jii = (I, g, A) => (i.dynCall_jii = Y.qa)(I, g, A));
      var fg = (i.dynCall_viiij = (I, g, A, e, t, o) =>
        (fg = i.dynCall_viiij = Y.ra)(I, g, A, e, t, o));
      (i.dynCall_jiji = (I, g, A, e, t) =>
        (i.dynCall_jiji = Y.sa)(I, g, A, e, t)),
        (i.dynCall_viijii = (I, g, A, e, t, o, l) =>
          (i.dynCall_viijii = Y.ta)(I, g, A, e, t, o, l)),
        (i.dynCall_iiiiij = (I, g, A, e, t, o, l) =>
          (i.dynCall_iiiiij = Y.ua)(I, g, A, e, t, o, l)),
        (i.dynCall_iiiiijj = (I, g, A, e, t, o, l, a, c) =>
          (i.dynCall_iiiiijj = Y.va)(I, g, A, e, t, o, l, a, c)),
        (i.dynCall_iiiiiijj = (I, g, A, e, t, o, l, a, c, s) =>
          (i.dynCall_iiiiiijj = Y.wa)(I, g, A, e, t, o, l, a, c, s));
      function VC(I, g) {
        var A = N();
        try {
          H.get(I)(g);
        } catch (e) {
          if ((L(A), e !== e + 0)) throw e;
          F(1, 0);
        }
      }
      function wC(I, g, A) {
...
var _ = class {
  ...
  static async _loadWithBackup() {
    return (
      this._ModulePromise ||
        (this._ModulePromise = this._tryLoad(this._wasmURL).catch(async (C) => {
          let i = `https://unpkg.com/${Ig}@${qI}/dist/dotlottie-player.wasm`;
          console.warn(
            `Primary WASM load failed from ${this._wasmURL}. Error: ${C.message}`
          ),
          ...
          try {
            ...
            throw (
              (console.error(`Primary WASM URL failed: ${C.message}`),
...
Z(_, "_ModulePromise", null),
  Z(
    _,
    "_wasmURL",
    `https://cdn.jsdelivr.net/npm/${Ig}@${qI}/dist/dotlottie-player.wasm`
  );
var AI = class {
  constructor() {
    Z(this, "_eventListeners", new Map());
  }
  addEventListener(C, i) {
    let d = this._eventListeners.get(C);
    d || ((d = new Set()), this._eventListeners.set(C, d)), d.add(i);
  }
  removeEventListener(C, i) {
    let d = this._eventListeners.get(C);
    d &&
      (i
        ? (d.delete(i), d.size === 0 && this._eventListeners.delete(C))
        : this._eventListeners.delete(C));
  }
  dispatch(C) {
    this._eventListeners.get(C.type)?.forEach((d) => d(C));
  }
...
function gg(r) {
  ...
  for (let i = 0; i < wI.length; i += 1) if (wI[i] !== C[i]) return !1;
  return !0;
}
function Pg(r) {
...
var Ag = (r, C) =>
  ...
  W = class W {
    constructor(C) {
      ...
      (this._canvas = C.canvas),
        (this._context = this._canvas.getContext("2d")),
        (this._eventManager = new AI()),
        (this._frameManager = new VI()),
        (this._renderConfig = C.renderConfig ?? {}),
        _.load()
          .then((i) => {
            (W._wasmModule = i),
              (this._dotLottieCore = new i.DotLottiePlayer({
                ...
                backgroundColor: 0,
                loopAnimation: C.loop ?? !1,
                mode: Ag(C.mode ?? "forward", i),
                segment: tg(C.segment ?? [], i),
                speed: C.speed ?? 1,
                useFrameInterpolation: C.useFrameInterpolation ?? !0,
                marker: C.marker ?? "",
                layout: C.layout
                  ? { align: eg(C.layout.align, i), fit: ig(C.layout.fit, i) }
                  : i.createDefaultLayout(),
              })),
              this._eventManager.dispatch({ type: "ready" }),
              C.data
                ? this._loadFromData(C.data)
                : C.src && this._loadFromSrc(C.src),
              C.backgroundColor && this.setBackgroundColor(C.backgroundColor);
          })
          .catch((i) => {
            this._eventManager.dispatch({
              type: "loadError",
              error: new Error(`Failed to load wasm module: ${i}`),
            });
          }),
    ...
    _dispatchError(C) {
      console.error(C),
        this._eventManager.dispatch({ type: "loadError", error: new Error(C) });
    }
    async _fetchData(C) {
      let i = await fetch(C);
      if (!i.ok)
        throw new Error(
          `Failed to fetch animation data from URL: ${C}. ${i.status}: ${i.statusText}`
        );
    ...
    _loadFromSrc(C) {
      this._fetchData(C)
        ...
        .catch((i) =>
          this._dispatchError(
            `Failed to load animation data from URL: ${C}. ${i}`
          )
        );
    }
    ...
    get layout() {
      let C = this._dotLottieCore?.config().layout;
      if (C)
        return {
          align: [C.align.get(0), C.align.get(1)],
          fit: (() => {
            switch (C.fit) {
              case W._wasmModule?.Fit.Contain:
                return "contain";
              case W._wasmModule?.Fit.Cover:
                return "cover";
              case W._wasmModule?.Fit.Fill:
                return "fill";
              case W._wasmModule?.Fit.FitHeight:
                return "fit-height";
              case W._wasmModule?.Fit.FitWidth:
                return "fit-width";
              case W._wasmModule?.Fit.None:
                return "none";
              default:
                return "contain";
            }
    ...
    get manifest() {
      try {
        let C = this._dotLottieCore?.manifestString();
        if (this._dotLottieCore === null || !C) return null;
        let i = JSON.parse(C);
    ...
    get segment() {
      let C = this._dotLottieCore?.config().segment;
      if (C && C.size() === 2) return [C.get(0), C.get(1)];
    }
    get loop() {
      return this._dotLottieCore?.config().loopAnimation ?? !1;
    }
    get mode() {
      let C = this._dotLottieCore?.config().mode;
      return C === W._wasmModule?.Mode.Reverse
        ? "reverse"
        : C === W._wasmModule?.Mode.Bounce
        ? "bounce"
        : C === W._wasmModule?.Mode.ReverseBounce
        ? "reverse-bounce"
        : "forward";
    }
    get isFrozen() {
    ...
    load(C) {
      this._dotLottieCore === null ||
        ...
        (this._dotLottieCore.setConfig({
          ...
          backgroundColor: 0,
          loopAnimation: C.loop ?? !1,
          mode: Ag(C.mode ?? "forward", W._wasmModule),
          segment: tg(C.segment ?? [], W._wasmModule),
          speed: C.speed ?? 1,
          useFrameInterpolation: C.useFrameInterpolation ?? !0,
          marker: C.marker ?? "",
          layout: C.layout
            ? {
                align: eg(C.layout.align, W._wasmModule),
                fit: ig(C.layout.fit, W._wasmModule),
              }
            : W._wasmModule.createDefaultLayout(),
        }),
        C.data ? this._loadFromData(C.data) : C.src && this._loadFromSrc(C.src),
        this.setBackgroundColor(C.backgroundColor ?? ""));
    }
    _render() {
      if (this._dotLottieCore === null || this._context === null) return !1;
      if (this._dotLottieCore.render()) {
        let i = this._dotLottieCore.buffer(),
          d = new Uint8ClampedArray(
            i,
            0,
        ...
        return (
          typeof ImageData > "u"
            ? ((B = this._context.createImageData(
                this._canvas.width,
                this._canvas.height
              )),
              B.data.set(d))
            : (B = new ImageData(d, this._canvas.width, this._canvas.height)),
    ...
    _draw() {
      ...
      this._dotLottieCore.setFrame(C) &&
        (this._eventManager.dispatch({
          type: "frame",
          currentFrame: this._dotLottieCore.currentFrame(),
        }),
    ...
    setFrame(C) {
      if (
        this._dotLottieCore === null ||
        C < 0 ||
        C > this._dotLottieCore.totalFrames()
      )
        return;
      this._dotLottieCore.seek(C) &&
        (this._eventManager.dispatch({
          type: "frame",
          currentFrame: this._dotLottieCore.currentFrame(),
        }),
    ...
    setBackgroundColor(C) {
      this._dotLottieCore !== null &&
        (M && this._canvas instanceof HTMLCanvasElement
          ? (this._canvas.style.backgroundColor = C)
          : this._dotLottieCore.setConfig({
              ...this._dotLottieCore.config(),
              backgroundColor: Ug(C),
            }),
    ...
    resize() {
      if (M && this._canvas instanceof HTMLCanvasElement) {
        let i =
          ...
          { height: d, width: B } = this._canvas.getBoundingClientRect();
    ...
    loadAnimation(C) {
      if (
        this._dotLottieCore === null ||
        this._dotLottieCore.activeAnimationId() === C
      )
        return;
      this._dotLottieCore.loadAnimation(
        ...
        : this._eventManager.dispatch({
            type: "loadError",
            error: new Error(`Failed to animation :${C}`),
          });
    }
    setMarker(C) {
      this._dotLottieCore !== null &&
    ...
    markers() {
      let C = this._dotLottieCore?.markers();
      if (C) {
        let i = [];
    ...
    setLayout(C) {
      this._dotLottieCore === null ||
        ...
        this._dotLottieCore.setConfig({
          ...this._dotLottieCore.config(),
          layout: {
            align: eg(C.align, W._wasmModule),
            fit: ig(C.fit, W._wasmModule),
          },
        });
    }
    setViewport(C, i, d, B) {
      return this._dotLottieCore === null
        ? !1
        : this._dotLottieCore.setViewport(C, i, d, B);
    }
    static setWasmUrl(C) {
      _.setWasmUrl(C);
    }
    loadStateMachine(C) {
      return this._dotLottieCore?.loadStateMachine(C) ?? !1;
    }
    startStateMachine() {
      let C = this._dotLottieCore?.startStateMachine() ?? !1;
      return C && this._setupStateMachineListeners(), C;
    }
    stopStateMachine() {
      let C = this._dotLottieCore?.stopStateMachine() ?? !1;
    ...
    _getPointerPosition(C) {
      let i = this._canvas.getBoundingClientRect(),
        ...
        B = this._canvas.height / i.height,
        f = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1,
        P = ((C.clientX - i.left) * d) / f,
        T = ((C.clientY - i.top) * B) / f;
      return { x: P, y: T };
    }
    _onPointerUp(C) {
    ...
    postStateMachineEvent(C) {
      let i = this._dotLottieCore?.postEventPayload(C) ?? 1;
      return (
        i === 2
          ? this.play()
          : i === 3
    ...
    getStateMachineListeners() {
      ...
      let C = this._dotLottieCore.stateMachineFrameworkSetup(),
        i = [];
      for (let d = 0; d < C.size(); d += 1) i.push(C.get(d));
      return i;
    }
    ...
    loadStateMachineData(C) {
      return this._dotLottieCore?.loadStateMachineData(C) ?? !1;
    }
    animationSize() {
      let C = this._dotLottieCore?.animationSize().get(0) ?? 0,
        i = this._dotLottieCore?.animationSize().get(1) ?? 0;
      return { width: C, height: i };
    }
    setStateMachineBooleanContext(C, i) {
      return this._dotLottieCore?.setStateMachineBooleanContext(C, i) ?? !1;
    }
    setStateMachineNumericContext(C, i) {
      return this._dotLottieCore?.setStateMachineNumericContext(C, i) ?? !1;
    }
    setStateMachineStringContext(C, i) {
      return this._dotLottieCore?.setStateMachineStringContext(C, i) ?? !1;
    }
  };
...
var RI = class {
  constructor() {
    Z(this, "_workers", new Map());
    Z(this, "_animationWorkerMap", new Map());
  }
  getWorker(C) {
    return (
      this._workers.has(C) || this._workers.set(C, new hI()),
      this._workers.get(C)
    );
  }
...
function Qg(r) {
  if (r instanceof OffscreenCanvas) return { width: r.width, height: r.height };
...
var J = class J {
  constructor(C) {
    ...
    (this._worker = J._workerManager.getWorker(i)),
      J._workerManager.assignAnimationToWorker(this._id, i),
      J._wasmUrl && this._sendMessage("setWasmUrl", { url: J._wasmUrl }),
      this._create(C),
  ...
  async _create(C) {
    ...
    this._canvas instanceof HTMLCanvasElement
      ...
      : (i = this._canvas);
    let { instanceId: d } = await this._sendMessage(
      "create",
      {
        instanceId: this._id,
        config: { ...C, canvas: i },
  ...
  async setSpeed(C) {
    this._created &&
      (await this._sendMessage("setSpeed", { instanceId: this._id, speed: C }),
      await this._updateDotLottieInstanceState());
  }
  async setMode(C) {
    this._created &&
      (await this._sendMessage("setMode", { instanceId: this._id, mode: C }),
      await this._updateDotLottieInstanceState());
  }
  async setFrame(C) {
    this._created &&
      (await this._sendMessage("setFrame", { frame: C, instanceId: this._id }),
      await this._updateDotLottieInstanceState());
  }
  ...
  async loadTheme(C) {
    ...
    let i = this._sendMessage("loadTheme", {
      instanceId: this._id,
      themeId: C,
    });
  ...
  async load(C) {
    this._created &&
      (await this._sendMessage("load", { config: C, instanceId: this._id }),
      await this._updateDotLottieInstanceState());
  }
  async setLoop(C) {
    this._created &&
      (await this._sendMessage("setLoop", { instanceId: this._id, loop: C }),
      await this._updateDotLottieInstanceState());
  }
  async resize() {
  ...
  async destroy() {
    this._created &&
      ...
      this._cleanupStateMachineListeners(),
      J._workerManager.unassignAnimationFromWorker(this._id),
      this._eventManager.removeAllEventListeners());
  }
  async freeze() {
    this._created &&
  ...
  async _updateDotLottieInstanceState() {
    if (!this._created) return;
    let C = await this._sendMessage("getDotLottieInstanceState", {
      instanceId: this._id,
    });
  ...
  async loadThemeData(C) {
    if (!this._created) return !1;
    let i = await this._sendMessage("loadThemeData", {
      instanceId: this._id,
      themeData: C,
    });
    return await this._updateDotLottieInstanceState(), i;
  ...
  async _sendMessage(C, i, d) {
    ...
    return (
      this._worker.postMessage(B, d || []),
      new Promise((f, P) => {
        let T = (v) => {
          let $ = v.data;
          $.id === B.id &&
            (this._worker.removeEventListener("message", T),
            $.error
              ? P(new Error(`Failed to execute method ${C}: ${$.error}`))
              : f($.result));
        };
  ...
  async loadStateMachine(C) {
    if (!this._created) return !1;
    let i = await this._sendMessage("loadStateMachine", {
      instanceId: this._id,
      stateMachineId: C,
    });
    return await this._updateDotLottieInstanceState(), i;
  ...
  async loadStateMachineData(C) {
    if (!this._created) return !1;
    let i = await this._sendMessage("loadStateMachineData", {
      instanceId: this._id,
      stateMachineData: C,
    });
    return await this._updateDotLottieInstanceState(), i;
  ...
  async startStateMachine() {
    ...
    let C = await this._sendMessage("startStateMachine", {
      instanceId: this._id,
    });
  ...
  async _setupStateMachineListeners() {
    if (M && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
      let C = await this._sendMessage("getStateMachineListeners", {
        instanceId: this._id,
      });
      C.includes("PointerUp") &&
        this._canvas.addEventListener("pointerup", this._pointerUpMethod),
